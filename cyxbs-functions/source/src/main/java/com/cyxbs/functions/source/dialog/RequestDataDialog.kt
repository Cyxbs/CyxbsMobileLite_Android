package com.cyxbs.functions.source.dialog
...
import com.cyxbs.functions.source.data.RequestContentItemData
...
class RequestDataDialog private constructor(
  context: Context,
  val itemData: com.cyxbs.functions.source.data.RequestContentItemData
  ...
  class Builder(
    ...
    override fun buildInternal(): com.cyxbs.functions.source.dialog.RequestDataDialog {
      setPositiveClick {
      ...
      return com.cyxbs.functions.source.dialog.RequestDataDialog(context, itemData)
    }
  }
