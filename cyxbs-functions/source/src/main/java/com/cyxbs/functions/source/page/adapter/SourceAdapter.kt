...
import com.cyxbs.functions.source.page.content.ItemContentsActivity
 ...
 */
class SourceAdapter : ListAdapter<com.cyxbs.functions.source.data.RequestItemData, SourceAdapter.SourceVH>(
  object : DiffUtil.ItemCallback<com.cyxbs.functions.source.data.RequestItemData>() {
    override fun areItemsTheSame(oldItem: com.cyxbs.functions.source.data.RequestItemData, newItem: com.cyxbs.functions.source.data.RequestItemData): Boolean {
      return oldItem.item.name == newItem.item.name
    }

    override fun areContentsTheSame(oldItem: com.cyxbs.functions.source.data.RequestItemData, newItem: com.cyxbs.functions.source.data.RequestItemData): Boolean {
  ...
  private fun setState(holder: SourceVH, data: com.cyxbs.functions.source.data.RequestItemData) {
    holder.apply {
  ...
  private fun setRequest(holder: SourceVH, data: com.cyxbs.functions.source.data.RequestItemData) {
    holder.apply {
