package com.cyxbs.functions.source.page.content
...
import com.cyxbs.functions.source.page.adapter.ItemContentsAdapter
import com.cyxbs.functions.source.page.request.SetRequestActivity
import com.cyxbs.functions.source.page.viewmodel.RequestContentsViewModel
  ...
  private fun initRecyclerView() {
    ...
    mViewModel.contentsData.observe { data ->
      adapter.submitList(data.contents.map {
        com.cyxbs.functions.source.data.RequestContentItemData(data.item, it)
      })
