package com.cyxbs.pages.course.page.item.touch.helper.move
...
import com.cyxbs.pages.course.page.item.touch.helper.move.utils.MoveAnimation
...
class MovableItemHelper(
  ...
  private inner class LongPressMovableItemListener : ILongPressItemListener {
    ...
    private fun changeScrollYIfNeed() {
      ...
      val courseScrollY = scroll.getScrollCourseY()
      ...
      val isNeedScrollUp =
        bottomHeight > scrollOuterHeight - moveBoundary
            ...
            && scroll.canCourseScrollVertically(1) // 是否滑到底
      ...
      val isNeedScrollDown =
        topHeight < moveBoundary
            ...
            && scroll.canCourseScrollVertically(-1) // 是否滑到顶
