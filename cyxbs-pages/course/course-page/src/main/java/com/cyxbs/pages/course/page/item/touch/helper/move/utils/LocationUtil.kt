package com.cyxbs.pages.course.page.item.touch.helper.move.utils
...
object LocationUtil {
  ...
  fun getLocation(
    ...
    * */
    ...
    val topDistance = parent.getRowsHeight(0, topRow) + parent.view.paddingTop - t
    val bottomDistance = b - (parent.getRowsHeight(0, bottomRow - 1) + parent.view.paddingTop)
    val leftDistance = parent.getColumnsWidth(0, leftColumn) + parent.view.paddingLeft - l
    val rightDistance = r - (parent.getColumnsWidth(0, rightColumn - 1) + parent.view.paddingLeft)
    ...
    * */
    for (i in 0 until parent.view.childCount) {
      val child = parent.view.getChildAt(i)
