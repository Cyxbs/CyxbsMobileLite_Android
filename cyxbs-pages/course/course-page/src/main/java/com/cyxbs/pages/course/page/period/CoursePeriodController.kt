 ...
 */
open class CoursePeriodController : CourseController(), ICoursePeriod {
  ...
  final override fun getLessonStartHeight(num: Int): Int {
    require(num >= 1)
    return page.course.getRowsHeight(0, transformLessonToNode(num) - 1) + page.course.view.paddingTop
  }
  ...
  final override fun getLessonEndHeight(num: Int): Int {
    require(num >= 1)
    return page.course.getRowsHeight(0, transformLessonToNode(num)) + page.course.view.paddingTop
  }
  ...
  final override fun getAmStartHeight(): Int {
    return page.course.getRowsHeight(0, AM_TOP - 1) + page.course.view.paddingTop
  }

  final override fun getAmEndHeight(): Int {
    return page.course.getRowsHeight(0, AM_BOTTOM) + page.course.view.paddingTop
  }
  ...
  final override fun getNoonStartHeight(): Int {
    return page.course.getRowsHeight(0, NOON_TOP - 1) + page.course.view.paddingTop
  }

  final override fun getNoonEndHeight(): Int {
    return page.course.getRowsHeight(0, NOON_BOTTOM) + page.course.view.paddingTop
  }
  ...
  final override fun getPmStartHeight(): Int {
    return page.course.getRowsHeight(0, PM_TOP - 1) + page.course.view.paddingTop
  }

  final override fun getPmEndHeight(): Int {
    return page.course.getRowsHeight(0, PM_BOTTOM) + page.course.view.paddingTop
  }
  ...
  final override fun getDuskStartHeight(): Int {
    return page.course.getRowsHeight(0, DUSK_TOP - 1) + page.course.view.paddingTop
  }

  final override fun getDuskEndHeight(): Int {
    return page.course.getRowsHeight(0, DUSK_BOTTOM) + page.course.view.paddingTop
  }
  ...
  final override fun getNightStartHeight(): Int {
    return page.course.getRowsHeight(0, NIGHT_TOP - 1) + page.course.view.paddingTop
  }

  final override fun getNightEndHeight(): Int {
    return page.course.getRowsHeight(0, NIGHT_BOTTOM) + page.course.view.paddingTop
  }
