...
import com.cyxbs.pages.course.view.course.controller.CourseScrollController
import com.cyxbs.pages.course.view.course.controller.ItemContainerController
import com.cyxbs.pages.course.view.course.controller.MultiTouchController
...
class CourseViewGroup @JvmOverloads constructor(
  ...
  defStyleRes: Int = 0
) : AbstractCourseViewGroup(context, attrs, defStyleAttr, defStyleRes), ICourseViewGroup {

  override val touch: IMultiTouch = MultiTouchController(this)

  override val scroll: ICourseScrollControl = CourseScrollController(this)

  override val container: IItemContainer = ItemContainerController(this)
}